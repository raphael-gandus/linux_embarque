...
J'ai d'abord installé Apache sur ma raspberry grâce à : sudo apt install apache2
J'ai ensuite créé un répertoire pour mon site : sudo mkdir /var/www/mon_site
J'ai mis à jour le propriétaire et les droits d'accès à ce répertoire grâce aux commandes : sudo chown -R pi /var/www/mon_site
...
J'ai ensuite activé l'hôte virtuel grâce à : sudo a2ensite mon_site.conf
J'ai verifié l'état des fichiers grâce à : sudo apache2ctl configtest, la console me renvoie le message "SYNTAX OK"
Enfin je recharge apache avec : systemctl reload apache2
